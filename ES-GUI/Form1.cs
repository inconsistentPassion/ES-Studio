...
namespace ES_GUI
{
    public partial class Form1 : Form
    {
        ...
        private string version = "0.3.2.0";
        ...
        // Drag Strip
        private DragStripUtil dragStripUtil;
        ...
        {
            dragStripUtil = new DragStripUtil();
            dragStripUtil.BuildProgrammaticUI(tabPage6);
            dragStripUtil.Initialize();
        }
            ...
            Thread t = new Thread(() =>
            {
                ...
                while (true)
                {
                    if (client.isConnected)
                    {
                        ...
                        if (dragStripUtil != null && dragStripUtil.Model != null && (dragStripUtil.Model.Running || dragStripUtil.Model.Staged))
                        {
                            dragStripUtil.Model.Update(client.update.vehicleSpeed, client.update.RPM, client.update.gear);
                        }
                    }
                    else
                    {
